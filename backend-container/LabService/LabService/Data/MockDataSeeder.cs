...
public static class MockIds
{
    ...
    // Medical Record IDs (from MedicalRecordsService)
...
public static class MockDataSeeder
{
    public static async Task SeedAsync(LabDbContext db)
    {
        ...
        // Lab Tests (linked to lab orders)
        ...
        // Lab Results (linked to lab tests)
        ...
        // Lab Result Reviews (for reviewed results)
        ...
        {
            await db.SaveChangesAsync();
            Console.WriteLine($"[MockDataSeeder] Created {created} lab records (orders, tests, results, reviews).");
        }
        else
        {
            Console.WriteLine("[MockDataSeeder] All lab mock data already exists.");
        }
    }
}
