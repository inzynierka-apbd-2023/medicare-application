...
param patientservice_containerport string
...
param patientservice_containerimage string

resource patientservice 'Microsoft.App/containerApps@2024-03-01' = {
  name: 'patientservice'
  location: location
  properties: {
    configuration: {
      ...
      ingress: {
        external: false
        targetPort: patientservice_containerport
        transport: 'http'
      }
      registries: [
        {
    ...
    template: {
      containers: [
        {
          image: patientservice_containerimage
          name: 'patientservice'
          env: [
            {
            ...
            {
              name: 'HTTP_PORTS'
              value: patientservice_containerport
            }
            {
