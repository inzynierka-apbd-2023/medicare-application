...
param documentsservice_containerport string
...
param documentsservice_containerimage string

resource documentsservice 'Microsoft.App/containerApps@2024-03-01' = {
  ...
  properties: {
    configuration: {
      ...
      ingress: {
        external: false
        targetPort: documentsservice_containerport
        transport: 'http'
      }
      registries: [
        {
    ...
    template: {
      containers: [
        {
          image: documentsservice_containerimage
          name: 'documentsservice'
          env: [
            {
            ...
            {
              name: 'HTTP_PORTS'
              value: documentsservice_containerport
            }
            {
