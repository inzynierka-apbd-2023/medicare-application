...
param medicalrecordsservice_containerport string
...
param medicalrecordsservice_containerimage string

resource medicalrecordsservice 'Microsoft.App/containerApps@2024-03-01' = {
  ...
  properties: {
    configuration: {
      ...
      ingress: {
        external: false
        targetPort: medicalrecordsservice_containerport
        transport: 'http'
      }
      registries: [
        {
    ...
    template: {
      containers: [
        {
          image: medicalrecordsservice_containerimage
          name: 'medicalrecordsservice'
          env: [
            {
            ...
            {
              name: 'HTTP_PORTS'
              value: medicalrecordsservice_containerport
            }
            {
