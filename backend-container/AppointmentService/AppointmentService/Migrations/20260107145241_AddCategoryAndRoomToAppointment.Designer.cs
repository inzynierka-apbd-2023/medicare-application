...
namespace AppointmentService.Migrations
{
    ...
    [Migration("20260107145241_AddCategoryAndRoomToAppointment")]
    partial class AddCategoryAndRoomToAppointment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppointmentService.Models.Doctor", b =>
                {
                    ...
                    b.ToTable("Doctor", "practitioner", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("AppointmentService.Models.DoctorSpecialization", b =>
                {
                    ...
                    b.ToTable("Doctor_Specialization", "practitioner", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("AppointmentService.Models.Specialization", b =>
                {
                    ...
                    b.ToTable("Specialization", "practitioner", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
