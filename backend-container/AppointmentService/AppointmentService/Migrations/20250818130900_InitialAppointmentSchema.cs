...
namespace AppointmentService.Migrations
{
    public partial class InitialAppointmentSchema : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "Appointment", schema: "appointment");
            migrationBuilder.DropTable(name: "Appointment_Slot", schema: "appointment");
            migrationBuilder.DropTable(name: "Schedule", schema: "appointment");
            migrationBuilder.DropTable(name: "Appointment_Category", schema: "appointment");
        }
    }
}
