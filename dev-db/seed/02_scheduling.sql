-- SCHEDULE + APPOINTMENT STATUS/ENTITIES
CREATE TABLE dbo.Schedule (
  Id          VARCHAR(36) NOT NULL CONSTRAINT DF_Schedule_Id DEFAULT dbo.NewGuidString(),
...
CREATE TABLE dbo.Schedule_Appointment_Status (
  Id         VARCHAR(36) NOT NULL CONSTRAINT DF_SAStatus_Id DEFAULT dbo.NewGuidString(),
  Name       NVARCHAR(100) NOT NULL,
  Description NVARCHAR(500) NULL,
  Color_Code NVARCHAR(7) NULL, -- e.g. #RRGGBB
...
CREATE TABLE dbo.Time_Slot (
  Id             VARCHAR(36) NOT NULL CONSTRAINT DF_TimeSlot_Id DEFAULT dbo.NewGuidString(),
...
CREATE TABLE dbo.Doctor_Schedule (
  Id          VARCHAR(36) NOT NULL CONSTRAINT DF_DoctorSchedule_Id DEFAULT dbo.NewGuidString(),
  Doctor_Id   VARCHAR(36) NOT NULL,
  Day_Of_W    TINYINT NOT NULL, -- 1..7
...
CREATE TABLE dbo.Schedule_Appointment (
  Id                               VARCHAR(36) NOT NULL CONSTRAINT DF_SA_Id DEFAULT dbo.NewGuidString(),
...
CREATE TABLE dbo.Appointment (
  Id                        VARCHAR(36) NOT NULL CONSTRAINT DF_Appointment_Id DEFAULT dbo.NewGuidString(),
