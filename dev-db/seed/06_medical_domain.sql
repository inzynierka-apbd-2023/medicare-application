...
CREATE TABLE dbo.Service (
  Id           VARCHAR(36) NOT NULL CONSTRAINT DF_Service_Id DEFAULT dbo.NewGuidString(),
...
CREATE TABLE dbo.Specialization (
  Id          VARCHAR(36) NOT NULL CONSTRAINT DF_Spec_Id DEFAULT dbo.NewGuidString(),
  Name        NVARCHAR(200) NOT NULL,
  Description NVARCHAR(1000) NULL,
...
CREATE TABLE dbo.Doctor_Specialization (
  Id               VARCHAR(36) NOT NULL CONSTRAINT DF_DocSpec_Id DEFAULT dbo.NewGuidString(),
...
CREATE TABLE dbo.Medical_Condition (
  Id          VARCHAR(36) NOT NULL CONSTRAINT DF_MedCond_Id DEFAULT dbo.NewGuidString(),
...
CREATE TABLE dbo.Patient_Medical_Condition (
  Id                 VARCHAR(36) NOT NULL CONSTRAINT DF_PMC_Id DEFAULT dbo.NewGuidString(),
...
CREATE TABLE dbo.Rate (
  Id            VARCHAR(36) NOT NULL CONSTRAINT DF_Rate_Id DEFAULT dbo.NewGuidString(),
