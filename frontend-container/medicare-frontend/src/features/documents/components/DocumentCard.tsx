...
const docTypeInfo: Record<DocumentType, { icon: React.ReactNode; color: string; badgeVariant: "default" | "success" | "warning" | "info" | "error" }> = {
  Prescription: {
...
export const DocumentCard: React.FC<DocumentCardProps> = ({
  ...
  return (
    <Card variant="default" padding="md" className="cursor-pointer hover:shadow-lg transition-shadow duration-200">
