...
const CompleteProfile: React.FC = () => {
  ...
  const registerData = useMemo(() => (location.state as any)?.registerData, [location.state]);
      ...
      <div className="auth-card">
        ...
        <form onSubmit={onSubmit} className="auth-form-small">
          <div className="form-group-small">
            ...
            <input id="phone" name="phone" value={form.phone} onChange={onChange} className="form-input text-sm" placeholder="+48 123 456 789" />
          </div>

          <div className="form-group-small">
            <label className="form-label" htmlFor="dateOfBirth">Date of Birth</label>
            <input id="dateOfBirth" type="date" name="dateOfBirth" value={form.dateOfBirth} onChange={onChange} className="form-input text-sm" />
          </div>

          <div className="form-group-small">
            <label className="form-label" htmlFor="avatarUrl">Avatar URL (optional)</label>
            <input id="avatarUrl" name="avatarUrl" value={form.avatarUrl || ""} onChange={onChange} className="form-input text-sm" placeholder="https://.../avatar.png" />
          </div>

          {/* Optional address fields — extend later to full profile */}
          <div className="grid-2">
            <div className="form-group-small">
              <label className="form-label" htmlFor="addressLine1">Address line 1</label>
              <input id="addressLine1" name="addressLine1" value={form.addressLine1} onChange={onChange} className="form-input text-sm" />
            </div>
            <div className="form-group-small">
              <label className="form-label" htmlFor="addressLine2">Address line 2</label>
              <input id="addressLine2" name="addressLine2" value={form.addressLine2} onChange={onChange} className="form-input text-sm" />
            </div>
          </div>
          ...
          <div className="grid-3">
            <div className="form-group-small">
              ...
              <input id="city" name="city" value={form.city} onChange={onChange} className="form-input text-sm" />
            </div>
            <div className="form-group-small">
              <label className="form-label" htmlFor="state">State</label>
              <input id="state" name="state" value={form.state} onChange={onChange} className="form-input text-sm" />
            </div>
            <div className="form-group-small">
              <label className="form-label" htmlFor="zipCode">Zip Code</label>
              <input id="zipCode" name="zipCode" value={form.zipCode} onChange={onChange} className="form-input text-sm" />
            </div>
          </div>

          <div className="form-group-small">
            <label className="form-label" htmlFor="country">Country</label>
            <input id="country" name="country" value={form.country} onChange={onChange} className="form-input text-sm" />
          </div>
